...
export const DESCRIPTIONS: Record<string, string> = {
    ...
    "assjobs": "Stimulation of genitals/toys using buttocks.",
    ...
    "chubby-pudge": "Bodies with noticeable body fat, typically on the belly.",
    ...
    "headless": "Attraction to headless creatures and individuals and arousal involving them.",
