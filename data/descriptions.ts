...
export const DESCRIPTIONS: Record<string, string> = {
    ...
    "big-clit": "Arousal from notably large clitorises that are twice the size of average clitorises.",
    ...
    "groping-non-consensual": "Arousal from groping another, without their consent, typically in public crowded area. (e.g. concerts, trains, etc.).",
    ...
    "upskirting-nc": "Arousal from the act of capturing an image or video under a person's skirt.",
