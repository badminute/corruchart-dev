...
export const DESCRIPTIONS: Record<string, string> = {
    ...
    "analingus-rimming-rimjobs": "Arousal from the act of oral pleasure to one's anus.",
    ...
    "audio-porn": "Audio only erotica like stories, roleplay (GFE/BFE), ramblefaps, etc.",
    ...
    "bbc": "Arousal from big black cocks and/or dildos resembling them.",
    ...
    "breast-milking": "Arousal from breast milking.",
    ...
    "cheating-homewrecker-affair": "Arousal from sexual relations with a taken person (adulterer) without their partner knowing.",
    ...
    "children-pedophilia-hebephilia": "Attraction to prepubescent and/or pubescent children aged 14 or below.",
    "chubby-pudge": "",
    ...
    "cbt-cock-and-ball-torture": "Arousal from pain and/or constriction to male genitals, like squeezing, ball busting, tickle torture, wax play, etc.",
    ...
    "coulrophilia-clowns": "Arousal from clown imagery or personas.",
    ...
    "dacryphilia-tears-sobbing": "Arousal from crying or distressed emotional states.",
    ...
    "dragons-dracophilia": "Attraction to the mythical, legendary creatures known as dragons.",
    ...
    "dubious-consent": "Arousal from scenarios where consent is ambiguous, coerced, or implied.",
    ...
    "erotophonophilia-lust-murder": "Arousal from committing or fantasizing about murder.",
    "erp": "Text-based roleplaying with sexual themes.",
    ...
    "feminization-sissification": "Arousal from (typically a man) embracing hyper-feminine traits, can also be a transformation.",
    ...
    "flashing-cyberflashing": "Arousal from the exhibitive act of exposing one's genitals or breasts to a stranger. This is indecent exposure.",
    ...
    "footwear-misc": "Arousal from a focus on typical kinds of shoes either worn or taken off.",
    ...
    "forced-feminization-sissification": "Arousal from (typically a man) being made to adopt hyper-feminine traits, usually as humiliation and can also be a forced transformation.",
    ...
    "group-sex-3-plus": "Sex involving more than two people.",
    ...
    "hybristophilia-crime": "Arousal from criminal acts.",
    ...
    "immobilization-quicksand-sticky-etc": "Arousal from seeing/being someone immobilized by a range of different causes from quicksand to slime to sticky substances.",
    ...
    "lesbian-yuri": "Arousal from romantic/sexual relationships and acts between women.",
    ...
    "navel-play": "Arousal from navels/belly buttons and the play of them.",
    ...
    "netorase": "In erotic media, the protagonist (STAG) encourages their partner to engage in sexual relations/acts with another, enjoyed by the protagonist. Also called Hotwifing/Hothusbanding, Sharing, Compersion, and Stag & Vixen.",
    ...
    "oviposition-ovaphilia": "Arousal from scenarios involving the expulsion of eggs or the reception of eggs.",
    ...
    "school-uniform": "Arousal from school uniforms and scenarios involving them.",
    ...
    "sideboob-underboob-boob-window-cleavage": "Arousal from partially exposed breasts (e.g. Sideboob, underboob, boob window, etc.).",
    ...
    "stag-and-vixen (Hotwifing)": "A dynamic where a dominant man encourages their wife to have sex with others, either present or on their own. There is no humiliation involved. Also called hotwifing. ",
    ...
    "thick-cum-solid-semen": "A type of hyper-cum depicted as thick, ropey, and solid like cheese or gelatin.",
    ...
    "tickle-fetish": "Arousal from tickling or being tickled. Sensory overload and a power dynamic come into play.",
    ...
    "urethra-play": "Activities involving the urethra.",
    ...
    "vaginal-prolapse": "A form of extreme stretching which results in at least one pelvic organ protruding into the vagina.",
