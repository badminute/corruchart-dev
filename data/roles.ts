...
export const ROLES: RoleOption[] = [
    ...
    { id: "princess", label: "Princess", aka: [], tags: ["BDSM Roles Misc."], category: 2, variantGroup: "princess-variants", variantOrder: 0 },
    { id: "princess-dominant", label: "Princess (Dominant)", aka: [], tags: ["BDSM Roles Misc."], category: 2, variantGroup: "princess-variants", variantOrder: 1 },
    { id: "prince", label: "Prince", aka: [], tags: ["BDSM Roles Misc."], category: 2, variantGroup: "prince-variants", variantOrder: 0 },
    { id: "prince-dominant", label: "Prince (Dominant)", aka: [], tags: ["BDSM Roles Misc."], category: 2, variantGroup: "prince-variants", variantOrder: 1 },
